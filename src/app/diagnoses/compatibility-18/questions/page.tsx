...
export default function Compatibility18QuestionsPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden px-2 py-10 lg:px-12">
      {/* 背景を全画面に固定 */}
      ...
      {/* スマホ用レイアウト */}
      <div className="relative z-10 mx-auto w-full space-y-8 lg:hidden">
        ...
        <div className="sticky top-0 z-20 -mx-2 border-b border-white/70 bg-white/90 backdrop-blur-2xl px-2 py-3 shadow-[0px_30px_80px_rgba(0,0,0,0.12),0px_15px_40px_rgba(0,0,0,0.08),inset_0px_1px_0px_rgba(255,255,255,0.8)]">
